        ...
        <section class="py-10 px-4">
            <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-6">
                <div class="bg-surface border border-border rounded-card p-6">
                    <p
                        class="text-content-tertiary text-xs uppercase tracking-wide"
                    >
                        Trésorerie
                    </p>
        ...
        <section class="py-10 px-4">
            <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
                <div class="bg-surface border border-border rounded-card p-6">
                    ...
                    <div
                        class="bg-surface-alt border border-border rounded-lg p-4"
                    >
                    ...
                    >
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <p class="text-white text-xl font-bold">
                                {formatCurrency(
                                    dashboardData.financials.stock_price,
                                )}
                            </p>
                        </div>
                        <div class="border-t border-border pt-3">
                            ...
                            <p class="text-white font-semibold text-lg">
                                {formatCurrency(
                                    dashboardData.financials.valuation,
                                )}
                            </p>
                        </div>
                    </div>
        ...
        <section class="py-4 px-4">
            <div class="max-w-7xl mx-auto">
                <div class="bg-surface border border-border rounded-card p-6">
                        ...
                        <div class="grid md:grid-cols-5 gap-3">
                            {#each dashboardData.resources.top_items as item}
                                ...
                                >
                                    ...
                                    <p
                                        class="text-content-secondary text-xs mt-1"
                                    >
                                        Qté: {item.qty}
                                    </p>
                                    <p
                    ...
                    {:else}
                        <p
                            class="text-content-secondary text-sm text-center py-4"
                        >
        ...
        <section class="py-4 px-4">
            ...
            >
                <p class="text-primary-300 text-sm">
                    Cette page contient des données mockées et sert uniquement
                    de maquette.
                </p>
            </div>
        </section>
                        ...
                        {#each mockedCompanies as c}
                            ...
                            >
                                ...
                                <div class="text-right">
                                    <p class="text-content-secondary text-xs">
                                        Revenus
                                    </p>
